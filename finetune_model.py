...
if __name__ == '__main__':
    ...
    parser.add_argument("-path",  "--path",  dest="path",  type=str, default="./saved_model/mnist_model/mnist_cae_FT2_30_pdglinf_ce_40_0.3_0.01_True_20_0.002_250_20_1_1_1_0.8_0.2_1/mnist_cae_adv200020.pth",  help="path to the model to finetune")
...
name = f"mnist_cae_FT2_3_{n_prototypes}_{args.adversarialattack}_{args.adversarialloss}_{args.iters}_{args.eps}_{args.alpha}_{args.randstart}_{args.epochs}_{args.lr}_{args.batchsize}_{args.lambdac}_{args.lambdae}_{args.lambda1}_{args.lambda2}_{args.lambdaclus}_{args.lambdasep}_{args.seed}"
...
model_filename = "mnist_cae_adv2_3"
optimizer_filename = "optimizer_cae_adv2_3"
...
elif args.adversarialloss == "advl":
    adversarial_loss = partial(Loss_1, alpha1=0, alpha2=1, objective="advl", force_class=None, change_expl=None)
