...
class PrototypeLayer(nn.Module):
    def __init__(self, in_channels=10, n_prototypes=15):
        ...
        self.prototype_distances = nn.Parameter(torch.rand(n_prototypes, in_channels, requires_grad=True).to(device))
